...
export default function VitalCard({ patientId }) { // Accept patientId as a prop
    ...
    return (
        <div className={styles.card}> {/* Card container */}
            <div className={styles.main}> {/* Main content container */}
                <div className={styles.head}> {/* Header container */}
                ...
                <div className={styles.formContainer}> {/* Form container */}
                    <form key={formKey} className={styles.form} onSubmit={handleSubmit}> {/* Form element */}
                        <div className={styles.vitalInput}> {/* Vital input container */}
                            <div className={styles.inputRow1}> {/* Input row 1 */}
                                <input
                                    id="temperature"
                            ...
                            <div className={styles.inputRow2}> {/* Input row 2 */}
                                <input
                                    id="weight"
                                    type="number" // Input type
                            ...
                            <div className={styles.inputRow3}> {/* Input row 3 */}
                                <input
                                    id="heart"
                                    type="text" // Input type
                            ...
                            <div className={styles.submit}> {/* Submit button container */}
                                <button
